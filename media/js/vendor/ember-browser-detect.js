...
window.Em = window.Em || { MODULE_INFO: {}, LAZY_INSTANTIATION: {} };

Ember._detectBrowser = function(userAgent, language) {
  ...
  */
  ...
  /**
    @name Ember.browser.isiOSHomeScreen
    @type Boolean
  */
...
/** @class
  ...
  is running in. String properties, such as `Ember.browser.webkit` or
  `Ember.browser.msie`, will have a value that represents the browser build
...
*/
Ember.browser = Ember._detectBrowser();
