...
class Spider(Model):
    ...
    country_code = String()
    local_images = Boolean(default=False)
    currency_code = String()
    use_language_config = Boolean(default=False)
    use_currency_config = Boolean(default=False)
    english_url = String()
    english_url_args = String()
    arabic_url = String()
    arabic_url_args = String()
    use_language_cookies= Boolean(default=False)
    use_currency_cookies= Boolean(default=False)
    english_cookie_name= String()
    english_cookie_value= String()
    arabic_cookie_name= String()
    arabic_cookie_value= String()
    currency_cookie_name= String()
    currency_cookie_value= String()
