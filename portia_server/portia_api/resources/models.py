...
class SpiderSchema(SlydSchema):
    ...
    local_images = fields.Boolean(default=False)
    currency_code = fields.Str()
    use_language_config = fields.Boolean(default=False)
    use_currency_config = fields.Boolean(default=False)
    english_url = fields.Str()
    english_url_args = fields.Str()
    arabic_url = fields.Str()
    arabic_url_args = fields.Str()
    use_language_cookies = fields.Boolean(default=False)
    use_currency_cookies = fields.Boolean(default=False)
    english_cookie_name = fields.Str()
    english_cookie_value = fields.Str()
    arabic_cookie_name = fields.Str()
    arabic_cookie_value = fields.Str()
    currency_cookie_name = fields.Str()
    currency_cookie_value = fields.Str()
